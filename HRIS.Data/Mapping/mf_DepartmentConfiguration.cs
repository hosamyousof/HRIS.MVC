...
{
    internal class mf_DepartmentConfiguration : EntityTypeConfiguration<mf_Department>
    {
        ...
        public mf_DepartmentConfiguration(string schema)
        {
            ...
            HasRequired(a => a.sys_User_updatedBy).WithMany(b => b.mf_Departments).HasForeignKey(c => c.updatedBy);
        }
    }
}