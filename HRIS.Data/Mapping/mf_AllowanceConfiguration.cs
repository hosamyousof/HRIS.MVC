...
{
    internal class mf_AllowanceConfiguration : EntityTypeConfiguration<mf_Allowance>
    {
        ...
        public mf_AllowanceConfiguration(string schema)
        {
            ...
            HasRequired(a => a.sys_User_updatedBy).WithMany(b => b.mf_Allowances).HasForeignKey(c => c.updatedBy);
        }
    }
}