...
{
    internal class mf_EmployeeAllowanceConfiguration : EntityTypeConfiguration<mf_EmployeeAllowance>
    {
        ...
        public mf_EmployeeAllowanceConfiguration(string schema)
        {
            ...
            HasRequired(a => a.sys_User_updatedBy).WithMany(b => b.mf_EmployeeAllowances).HasForeignKey(c => c.updatedBy);
        }
    }
}