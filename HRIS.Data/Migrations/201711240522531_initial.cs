    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.sys_Company", t => t.companyId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.updatedBy)
                .Index(t => t.companyId);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_Department", t => t.departmentId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.departmentId)
                .Index(t => t.updatedBy);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_ApplicationRequestType", t => t.applicationRequestTypeId, cascadeDelete: true)
                .ForeignKey("dbo.mf_DepartmentSection", t => t.departmentSectionId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.approverId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_ApplicationRequestType", t => t.applicationRequestTypeId, cascadeDelete: true)
                .ForeignKey("dbo.mf_Employee", t => t.employeeId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_Country", t => t.countryId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.countryId)
                .Index(t => t.updatedBy);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_Allowance", t => t.allowanceId, cascadeDelete: true)
                .ForeignKey("dbo.mf_Employee", t => t.employeeId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.employeeId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_Deduction", t => t.deductionId, cascadeDelete: true)
                .ForeignKey("dbo.mf_Employee", t => t.employeeId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.employeeId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.pr_PayrollEmployee", t => t.payrollEmployeeId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_Employee", t => t.employeeId, cascadeDelete: true)
                .ForeignKey("dbo.pr_Payroll", t => t.payrollId, cascadeDelete: true)
                .Index(t => t.payrollId)
                .Index(t => t.employeeId);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.sys_Company", t => t.companyId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.generatedBy, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .ForeignKey("dbo.ta_CutOffAttendance", t => t.cutOffAttendanceId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_PayrollGroup", t => t.payrollGroupId, cascadeDelete: true)
                .ForeignKey("dbo.sys_Company", t => t.companyId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.changeStatusBy, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.payrollGroupId)
                .Index(t => t.updatedBy)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .ForeignKey("dbo.ta_CutOffAttendanceSummary", t => t.cutOffAttendanceSummaryId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_HolidayType", t => t.holidayTypeId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.holidayTypeId)
                .Index(t => t.updatedBy);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_Employee", t => t.employeeId, cascadeDelete: true)
                .ForeignKey("dbo.sys_IdentificationDocument", t => t.identificationDocumentId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.employeeId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_Employee", t => t.employeeId, cascadeDelete: true)
                .ForeignKey("dbo.mf_Offense", t => t.offenseId, cascadeDelete: true)
                .ForeignKey("dbo.mf_PenaltyType", t => t.penaltyTypeId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.employeeId)
                .Index(t => t.offenseId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_Employee", t => t.employeeId, cascadeDelete: true)
                .ForeignKey("dbo.mf_WorkDays", t => t.workDayId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.employeeId)
                .Index(t => t.workDayId)
                .Index(t => t.updatedBy);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.sys_Setting", t => t.settingId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.settingId)
                .Index(t => t.companyId)
                .Index(t => t.updatedBy);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.sys_Menu", t => t.sourceMenuId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.sys_Permission", t => t.permissionId, cascadeDelete: true)
                .ForeignKey("dbo.sys_Role", t => t.roleId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.roleId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.sys_User", t => t.approverId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .ForeignKey("dbo.ta_ApplicationRequest", t => t.applicationRequestId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.mf_ApplicationRequestType", t => t.applicationRequestTypeId, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.assignTo, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.requestedBy, cascadeDelete: true)
                .ForeignKey("dbo.sys_User", t => t.updatedBy, cascadeDelete: true)
                .Index(t => t.applicationRequestTypeId)
                .Index(t => t.assignTo)
